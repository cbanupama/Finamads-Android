...
public class SharedPreferenceUtil {
    ...
    public String getStringPreferenceData(String keyy, String defaultValuee) {
        String value = null;
        if (sharedPreferences != null) {
            value = sharedPreferences.getString(keyy, defaultValuee);
        }
        return value;
    }
     ...
     * @return true if the new value was successfully written to persistent storage.
     */
    public boolean setStringPreferenceData(String key, String value) {
        if (this.sharedPreferences != null && !TextUtils.isEmpty(key)) {
            SharedPreferences.Editor editor = this.sharedPreferences.edit();
            editor.putString(key, value);
            return editor.commit();
    ...
    *//**
    ...
    public boolean setUserIdPreference(String key, int value) {
        if (this.sharedPreferences != null && !TextUtils.isEmpty(key)) {
            SharedPreferences.Editor editor = this.sharedPreferences.edit();
            editor.putInt(key, value);
            return editor.commit();
    ...
    public int getUserIdPreference(String key, int defaultValue) {
        int value = 0;
        if (sharedPreferences != null) {
            value = sharedPreferences.getInt(key, defaultValue);
        }
   ...
   /* *//**
     ...
     * @return The value from shared preferences, or null if the value could not be read.
     *//*
    public String getStringTokenPreference(String tkey, String tdefaultValue) {
        String tvalue = null;
        if (sharedPreferences != null) {
            tvalue = sharedPreferences.getString(tkey, tdefaultValue);
        }
        return tvalue;
    }
    ...
    *//**
     ...
     * @return true if the new value was successfully written to persistent storage.
     *//*
    public boolean setStringTokenPreference(String ttkey, String ttvalue) {
        if (this.sharedPreferences != null && !TextUtils.isEmpty(ttkey)) {
            SharedPreferences.Editor editor = this.sharedPreferences.edit();
            editor.putString(ttkey, ttvalue);
            return editor.commit();
        }
        return false;
    }*/
