...
public class ActiveCampaginAdapter extends RecyclerView.Adapter<ActiveCampaginAdapter.ViewHolder> implements Serializable {

    private List<GetActiveCampaigns> minsidejobCardlist;
    private ActiveCampaginAdapter.PostItemListener mItemListener;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, ActiveCampaginAdapter.PostItemListener postItemListener) {
            super(itemView);
    ...
    public ActiveCampaginAdapter(Context context, List<GetActiveCampaigns> categories) {
    ...
    @Override
    public ActiveCampaginAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ActiveCampaginAdapter.ViewHolder viewHolder = new ActiveCampaginAdapter.ViewHolder(postView, this.mItemListener);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final ActiveCampaginAdapter.ViewHolder holder, final int position) {

        final GetActiveCampaigns item = minsidejobCardlist.get(position);
        ...
        holder.campaignLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("ActiveCampaignItem", item);
    ...
    private GetActiveCampaigns getItem(int adapterPosition) {
